...
<!-- ASSET SLOT (#101, after first release #93): license badge.
     The repo has no LICENSE file yet — pick one, commit it, then uncomment:
[![License](https://img.shields.io/github/license/Taklin1/island)](LICENSE)
-->

<!-- ASSET SLOT (#101, after first release #93): hero screenshot of the Island
     panel open over a desktop, light + dark themes, captured on a published
     build. Files: docs/assets/hero-light.png, docs/assets/hero-dark.png.
...
<!-- ASSET SLOT (#101, after first release #93): demo GIF of the nominal path —
     a session working → turn finishes → peek + green edge outline →
     click-to-focus back to the terminal. Captured on a published build.
